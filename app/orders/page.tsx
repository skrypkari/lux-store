        ...
        <div className="space-y-8 rounded-2xl border border-black/10 bg-white p-6 shadow-lg sm:p-8 lg:p-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4 font-general-sans leading-relaxed text-black/80">
                  <p>
                    <strong>Online:</strong> you can pay with the following
                    credit cards (American Express, Visa, Mastercard).
                  </p>
                  <p>
                    You can also choose to pay by <strong>Credit Card</strong>,{" "}
                    <strong>Apple Pay</strong>, <strong>Google Pay</strong>,{" "}
                    <strong>SEPA</strong>, <strong>Open Banking</strong>,{" "}
              ...
              <div>
                ...
                <ul className="list-inside list-disc space-y-2 font-general-sans leading-relaxed text-black/80">
                  ...
                  <li>
                    LUX STORE will inform you of the progress of your order by
                    email
                  </li>
                  <li>
                    After confirmation, your local carrier (DHL or UPS) will
                    provide an estimated delivery date
                  </li>
                  <li>
                    You will receive a tracking number to follow the shipment on
              ...
              <div>
                ...
                <div className="space-y-3 font-general-sans leading-relaxed text-black/80">
                  <p>
                    All creations that feature an{" "}
                    <strong>"Add to Shopping Bag"</strong> button on the product
                    page are available for purchase online.
                  </p>
                  <p>
                    If you are interested in a creation whose product page does
                    not show the "Add to Shopping Bag" button please{" "}
                    <Link
                      href="/contact"
                      className="font-semibold underline underline-offset-2 hover:text-black"
                    >
              ...
              <div>
                ...
                <div className="space-y-3 font-general-sans leading-relaxed text-black/80">
                  <p>
                    Each order can include a{" "}
                    <strong>maximum of 5 creations</strong>.
                  </p>
                  <p>
                    If you wish to purchase more than 5 creations in one order,
                    please{" "}
                    <Link
                      href="/contact"
                      className="font-semibold underline underline-offset-2 hover:text-black"
              ...
              <div>
                ...
                <div className="space-y-3 font-general-sans leading-relaxed text-black/80">
                  <p>
                    When you purchase a creation on LUX STORE, it will be
                    accompanied by a{" "}
                    <strong>certificate of authenticity</strong>.
                  </p>
                  <div className="rounded-lg border border-black/10 bg-black/5 p-4">
                    <p className="text-sm">
                      <strong>Important:</strong> In case you wish to return or
                      exchange a creation, it will be mandatory to include this
                      certificate into the return parcel.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3 font-general-sans leading-relaxed text-black/80">
                  <p>
                    Delivery lead times and fees depend on your delivery
                    address.
                  </p>
                  <p>
                    You can check the estimated delivery time in the checkout
                    page while processing your order online.
                  </p>
                  <div className="rounded-lg border border-black/10 bg-black/5 p-4">
                    <p className="text-sm">
                      <strong>Please note:</strong> This is an estimate and not
                      a guarantee.
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="space-y-3 font-general-sans leading-relaxed text-black/80">
                  <p>
                    Orders placed on the LUX STORE website are beautifully
                    wrapped in the signature Brand gift wrapping and delivered
                    in the Brand box.
                  </p>
                  <p>
                  ...
                  <p>
                    All orders placed on the website are also placed in
                    especially designed discreet protected packaging for
                    delivery.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3 font-general-sans leading-relaxed text-black/80">
                  <p>
                    You may use any residential or workplace address where the
                    carrier can hand over the parcel personally.
                  </p>
                  <div className="rounded-lg border border-black/10 bg-black/5 p-4">
                    <p className="text-sm">
                      <strong>This does not include:</strong> Military
                      addresses, certain restricted areas, pick-up points, or PO
                      boxes.
                    </p>
                  </div>
                </div>
              ...
              <div>
                <h3 className="mb-3 font-satoshi text-xl font-bold">
                  Can I ship my order to multiple addresses if I purchase
                  several products?
                </h3>
                <p className="font-general-sans leading-relaxed text-black/80">
                  We are unable to ship a single order to multiple addresses. If
                  you are ordering more than one item, we suggest you place a
                  separate order for each purchase.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4 font-general-sans text-sm leading-relaxed text-black/80">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      Italy, Malta, Montenegro, North Macedonia, Portugal, San
                      Marino, Serbia, Slovenia, Spain, Vatican City
                    </p>
                  </div>
                  <div>
                    <p className="mb-2 font-semibold text-black">
                    ...
                    <p>
                      ...
                      Georgia, Hungary, Moldova, Poland, Romania, Slovakia,
                      Ukraine
                    </p>
                  </div>
                </div>
              ...
              <div className="rounded-xl border border-black/10 bg-black/5 p-6">
                ...
                <div className="space-y-4 font-general-sans text-sm leading-relaxed text-black/80">
                  ...
                  <div>
                    ...
                    <p>
                      Cyprus, Israel, Jordan, Kuwait, Lebanon, Oman, Qatar,
              ...
              <div className="rounded-xl border border-black/10 bg-black/5 p-6">
                ...
                <p className="font-general-sans text-sm leading-relaxed text-black/80">
                  Greenland, U.S. Virgin Islands, British Virgin Islands, French
                  Polynesia, Isle of Man, Gibraltar
                </p>
              </div>
            </div>
          </section>
          ...
          <div className="mt-8 rounded-xl border border-black/10 bg-gradient-to-r from-black/5 to-transparent p-8 text-center">
            ...
            <p className="mb-6 font-general-sans text-black/60">
              Our team is here to help you with any inquiries about orders and
              delivery
            </p>
            <Link href="/contact">
              <Button
