    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-[#FEFEFE] to-[#FAFAFA] py-20">
      <div className="container mx-auto max-w-2xl px-4">
        <div className="text-center">
          ...
          {/* Title */}
          <h1 className="mb-4 font-satoshi text-4xl font-bold text-black">Payment Failed</h1>
          <p className="mb-2 font-general-sans text-xl text-black/70">
            We couldn't process your payment
          </p>
          <p className="mb-8 font-general-sans text-black/60">
            There was an issue with your card. Please check your details and try again.
          </p>
          ...
          <div className="mb-10 rounded-2xl border border-red-500/20 bg-red-50 p-6">
            ...
            <p className="font-general-sans text-sm leading-relaxed text-red-800">
              Your card was declined. This could be due to insufficient funds, incorrect card
              details, or your bank's security measures. Please verify your information or try a
            ...
            <div className="space-y-3 rounded-2xl border border-black/10 bg-white p-6 shadow-lg">
              <div className="flex items-start gap-3">
                ...
                <p className="font-general-sans text-sm text-black/70">
                  <span className="font-bold text-black">Incorrect card details</span> — Verify
              ...
              <div className="flex items-start gap-3">
                <div className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-black/40" />
                <p className="font-general-sans text-sm text-black/70">
                  <span className="font-bold text-black">Insufficient funds</span> — Check your
                  account balance
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-black/40" />
                <p className="font-general-sans text-sm text-black/70">
                  <span className="font-bold text-black">Card restrictions</span> — Contact your
                  bank for international or online purchase authorization
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-black/40" />
                <p className="font-general-sans text-sm text-black/70">
                  <span className="font-bold text-black">Expired card</span> — Make sure your card
                  is still valid
                </p>
              </div>
            </div>
