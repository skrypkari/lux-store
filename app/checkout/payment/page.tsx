...
function PaymentPageContent() {
  ...
  const getCardType = (cardNumber: string): string => {
    ...
    if (
      /^5[1-5]/.test(cleaned) ||
      /^2(22[1-9]|2[3-9][0-9]|[3-6][0-9]{2}|7[0-1][0-9]|720)/.test(cleaned)
    ) {
      return "mastercard";
    }
    ...
    try {
      ...
      setTimeout(() => {
        ...
        if (isSuccessCard) {
          ...
          router.push(
            `/checkout/success?orderId=${order.id}&token=${order.access_token}`
          );
        } else {
  ...
  if (order.payment_method === "plisio") {
    return (
      <div className="min-h-screen bg-gradient-to-b from-white via-[#FEFEFE] to-[#FAFAFA] py-12">
        <div className="container mx-auto max-w-2xl px-4">
          <div className="text-center">
            <p className="mb-4 font-general-sans text-black/60">
              Redirecting to cryptocurrency selection...
            </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={`h-14 border-black/20 font-general-sans text-lg uppercase ${
                      ...
                      !validateCardholderName(cardData.cardName)
                        ? "border-red-500 focus-visible:ring-red-500"
                        : ""
                    }`}
                  />
                ...
                {error && (
                  <div className="flex items-center gap-2 rounded-xl border border-red-500/20 bg-red-50 px-4 py-3">
                    ...
                    <p className="font-general-sans text-sm text-red-900">
                      {error}
                    </p>
                  </div>
                )}
