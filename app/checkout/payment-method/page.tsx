    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-[#FEFEFE] to-[#FAFAFA] py-20">
      <div className="container mx-auto max-w-4xl px-4">
        <div className="mb-12 text-center">
          ...
          <h1 className="mb-3 font-satoshi text-5xl font-bold">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            ...
            <h2 className="mb-3 font-satoshi text-2xl font-bold">
              Credit / Debit Card
            </h2>
          ...
          >
            ...
            <h2 className="mb-3 font-satoshi text-2xl font-bold text-white">
              Cryptocurrency
            </h2>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="font-general-sans text-sm leading-relaxed text-black/70">
                ...
                payment information is never stored on our servers. Card
                payments are processed securely, and cryptocurrency payments are
                handled via Plisio gateway.
              </p>
            </div>
          </div>
        </div>
